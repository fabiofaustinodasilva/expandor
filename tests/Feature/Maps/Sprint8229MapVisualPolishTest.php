...
class Sprint8229MapVisualPolishTest extends TestCase
{
    ...
    public function test_map_scripts_cache_bust_and_house_pin_assets(): void
    {
        ...
        $this->assertStringContainsString('operational-map.js?v=58', $html);
    ...
    public function test_seller_and_manager_share_same_marker_system(): void
    {
        ...
        $this->assertStringContainsString('operational-map.js?v=58', $managerHtml);
        ...
        $this->assertStringContainsString('operational-map.js?v=58', $sellerHtml);
