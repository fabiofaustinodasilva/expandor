...
- [x] Mensagem clara se GPS falhar
- [x] Confirmação após salvar no mapa
- [x] Equipe → Produtos
- [x] Financeiro → Produtos
- [x] Safe-area / toque mínimo 44px
- [ ] Validação manual em aparelho real (GPS + swipe)
