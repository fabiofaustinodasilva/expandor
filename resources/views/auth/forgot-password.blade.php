...
<body>
<div class="card {{ $themeService->contrastClass($brand) }}" data-forgot-password-form="1">
    <header class="brand-hero">
        ...
        @endif
        <p class="brand-hero__welcome">Recuperar senha</p>
        <p class="brand-hero__subtitle">Informe seu e-mail.</p>
    </header>

    @if(session('status'))
        <div class="status" role="status" data-password-reset-status="1">{{ session('status') }}</div>
    @endif
