...
class PlatformDashboardMetrics
{
    ...
    public function __construct(
        ...
        public readonly int $saasOnboardingStarted = 0,
        public readonly int $saasOnboardingCompleted = 0,
        public readonly float $activationRate = 0,
        public readonly ?float $averageActivationTimeHours = null,
